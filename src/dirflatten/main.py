...
globe.TLDN = Prompt.ask("Enter the directory to flatten:", default=os.getcwd())
UI.create_ui()
UI = UI()
...
files_in_directory = DF.get_files_in_directory(globe.TLDN)
...
with Live(UI.layout, console=UI.console, refresh_per_second=30) as live:
    ...
    for file in files_in_directory:
        DF.process_file(file, globe.TLDN)  # Process the file
    ...
    files_after_move = DF.get_files_in_directory(globe.TLDN)
